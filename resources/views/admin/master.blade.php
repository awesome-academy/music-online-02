            ...
            <ul class="sidebar navbar-nav">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="pagesDropdown">
                        ...
                        <a class="dropdown-item" href="{{ route('categories') }}">{{ trans('label.category') }}</a>
                        <a class="dropdown-item" href="#">{{ trans('label.artist') }}</a>
                        ...
                        <a class="dropdown-item" href="#">{{ trans('label.roles') }}</a>
