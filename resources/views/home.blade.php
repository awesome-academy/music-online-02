                                        ...
                                        <div class="pos-rlt">
                                            ...
                                            <div class="item-overlay opacity r r-2x bg-black">
                                                ...
                                                <div class="bottom padder m-b-sm"> 
                                                    <a data-id ="{{ $items->id }}" href="#" class="pull-right favorite" data-toggle="class"> 
                                                        <i data-id ="{{ $items->id }}" class="fa fa-heart-o text favorite"></i>
                                                        <i data-id ="{{ $items->id }}" class="fa fa-heart text-active text-danger unfavorite"></i>
                                                    </a> 
                                                ...
                                                @endphp
                                                <input type="hidden" value="{{ $user_id }}" id="user_favorite">
                                                @endif                                
                                            </div>
