            ...
            <section class="hbox stretch">
                ...
                <section class="vbox">
                    <section class="scrollable padder-lg w-f-md" id="bjax-target">
                        ...
                        <h2 class="font-thin m-b">{{ trans('label.music') }} <span class="bar1 a1 bg-primary lter"></span> <span class="bar2 a2 bg-info lt"></span> <span class="bar3 a3 bg-success"></span> <span class="bar4 a4 bg-warning dk"></span> <span class="bar5 a5 bg-danger dker"></span> </span></h2>
